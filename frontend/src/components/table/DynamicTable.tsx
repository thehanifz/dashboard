              ...
              >
                ...
                <tbody>
                  {pagination.rows.map((r) => {
                    const status = statusMaster ? r.data?.[statusMaster.status_column] : r.data?.StatusPekerjaan;
                        ...
                        {columns.map((col) => {
                            ...
                            return (
                              ...
                              >
                                 ...
                                 >
                                    {statusMaster ? renderCell(r, col, labelColors, statusMaster.status_column, statusMaster.detail_column) : renderCell(r, col, labelColors)}
                                 </div>
                              </td>
                            )
                        })}
